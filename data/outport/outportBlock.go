//go:generate protoc -I=. -I=$GOPATH/src/github.com/TerraDharitri/drt-go-core/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/TerraDharitri/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto

package outport

import (
	"github.com/TerraDharitri/drt-go-core/data"
	"github.com/TerraDharitri/drt-go-core/data/block"
)
